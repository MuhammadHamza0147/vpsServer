    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                {{-- header-wrap d-flex justify-content-between align-items-center --}}
                <!-- Search Bar -->
                <div class="col-xl-4 col-md-6 col-sm-7 search-bar order-sm-1 order-2">
                    <form class="d-flex align-items-center" onsubmit="handleSearch(event)">
                        <input type="text"  class="form-control" name="query" placeholder="Search..."  style="border-radius: 20px; padding: 5px 15px;"/>
                        <button  type="submit"  class="btn btn-primary ml-2" style="border-radius: 20px; height: 38px;">
                            <i class="zmdi zmdi-search"></i>
                        </button>
                    </form>
                </div>

                <div class="col-sm-5 header-button order-sm-2 order-1 mb-sm-0 mb-3 justify-content-sm-end justify-content-start">
